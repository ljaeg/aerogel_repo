...
from tensorflow.keras.layers import Concatenate, Multiply, Average, Maximum
...
convZ_6 =Conv2D(2 * conv_scale, kernel_size = (3, 3))(convZ_5)
...
convX_3 = Conv2D(2 * conv_scale, kernel_size = (3, 3))(spatialX_1)
...
convY_3 = Conv2D(2 * conv_scale, kernel_size = (3, 3))(spatialY_1)
...
merge = Maximum()([flat_Z, flat_X, flat_Y]) #Concatenate()([flat_Z, flat_X, flat_Y])
