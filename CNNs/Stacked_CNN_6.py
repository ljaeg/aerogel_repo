...
dense_2 = Dense(dense_scale, activation = "hard_sigmoid", kernel_regularizer = regularizers.l1_l2(l1 = .005, l2 = .01))(dropout_1)
dropout_2 = Dropout(dropout_rate)(dense_2)
dense_3 = Dense(dense_scale, activation = "hard_sigmoid", kernel_regularizer = regularizers.l1_l2(l1 = .005, l2 = .01))(dropout_2)
